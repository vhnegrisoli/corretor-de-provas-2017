 ...
 */
import javax.swing.*;
public class ObjetivasESubjetivas extends javax.swing.JFrame {

    /**
     * Creates new form ObjetivasESubjetivas
     */
    public ObjetivasESubjetivas() {
        initComponents();
        ...
        corrigirSubjetivas.setEnabled(false);
    }
    CorretorObjetivasSubjetivas objetivasSubjetivas = new CorretorObjetivasSubjetivas();
    /**
    ...
    private void initComponents() {
        ...
        corrigirSubjetivas = new javax.swing.JButton();
        ...
        corrigirSubjetivas.setText("Corrigir subjetivas");
        corrigirSubjetivas.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        corrigirSubjetivas.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                corrigirSubjetivasActionPerformed(evt);
            }
        });
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGap(35, 35, 35)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(valorQ, javax.swing.GroupLayout.DEFAULT_SIZE, 170, Short.MAX_VALUE)
                            ...
                            .addComponent(corrigirSubjetivas, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addGroup(layout.createSequentialGroup()
                        .addComponent(corrigirSubjetivas, javax.swing.GroupLayout.PREFERRED_SIZE, 34, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(valorQ, javax.swing.GroupLayout.PREFERRED_SIZE, 36, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createSequentialGroup()
                    ...
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        ...
                        .addGroup(layout.createSequentialGroup()
                            ...
                            .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                            .addComponent(mediaAp, javax.swing.GroupLayout.PREFERRED_SIZE, 20, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void corrigirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_corrigirActionPerformed
        try{
            objetivasSubjetivas.mostrarRespostas(nomeAluno.getText());
        }catch(Exception e){
    ...
    private void valorQActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_valorQActionPerformed
        objetivasSubjetivas.valorDasQuestoes();
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        valorProva.setText("");
        nomeAluno.setText("");
        objetivasSubjetivas = new CorretorObjetivasSubjetivas();
    ...
    private void gravarValorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_gravarValorActionPerformed
        try{
            ...
            valorProva.setEnabled(false);
            gravarValor.setEnabled(false);
            objetivasSubjetivas.valorTotalDaProva(Integer.parseInt(valorProva.getText()));
        }catch(Exception e){
    ...
    private void mediaApActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_mediaApActionPerformed
        try{
            ...
            corrigirSubjetivas.setEnabled(true);
            objetivasSubjetivas.mediaParaAprovacao(Integer.parseInt(mediaAp.getText()));
        }catch(Exception e){
            JOptionPane.showMessageDialog(null, "Por favor, insira algum valor no campo.");
            mediaAp.setEnabled(true);
            gravarAp.setEnabled(true);
    ...
    private void criarGActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_criarGActionPerformed
        objetivasSubjetivas.setGabarito();
    ...
    private void exibirGActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_exibirGActionPerformed
        objetivasSubjetivas.exibirGabarito();
    ...
    private void exibirAActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_exibirAActionPerformed
        objetivasSubjetivas.exibirAlternativas();
    ...
    private void alternativaAActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_alternativaAActionPerformed
        ...
        objetivasSubjetivas.respostasAluno();
    ...
    private void qtdQActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_qtdQActionPerformed
        try{
            ...
            gravarQtd.setEnabled(false);
            objetivasSubjetivas.quantidadeDeQuestoes(Integer.parseInt(qtdQ.getText()));
        }catch(Exception e){
            JOptionPane.showMessageDialog(null, "Por favor, insira algum valor no campo.");
            valorProva.setEnabled(false);
            gravarValor.setEnabled(false);
    ...
    private void corrigirSubjetivasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_corrigirSubjetivasActionPerformed
        objetivasSubjetivas.corrigirSubjetivas();
    }//GEN-LAST:event_corrigirSubjetivasActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ObjetivasESubjetivas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ObjetivasESubjetivas().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JButton corrigirSubjetivas;
